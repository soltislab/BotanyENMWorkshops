...
write.csv(iDigBio_GU_family, "data/01_download/iDigBio_GU_family_2026_07_22.csv", row.names = FALSE)
...
gators_download(synonyms.list = Pyxidanthera_brevifolia,
                write.file = TRUE,
                filename = "data/01_download/raw/Pyxidanthera_brevifolia_raw_2026_07_22.csv")
